<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerpage.aspx.cs" Inherits="sree_bavan_bakery.adminpage" %>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="customerpage.aspx" class="nav-item nav-link active">customerdetails</a>
        ...
        <div class="container">
            <div class="heading_container">
                <div class="align-self-end">
                    ...
                    <div>
                        <h1 class="text-primary font-secondary">Customer Details</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="lbdelete" runat="server" Text="remove" CommandName="Remove"
                                CommandArgument='<%#Eval("id") %>' OnClientClick="return confirm('do you want remove thid item from cart');">
