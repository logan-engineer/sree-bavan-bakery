<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menu.aspx.cs" Inherits="sree_bavan_bakery.menu" %>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="menu.aspx" class="nav-item nav-link active">Menu & Pricing</a>
            ...
            <div class="container ">
                ...
                <div class="tab-class text-center">
                    ...
                    <ul class="nav nav-pills d-inline-flex justify-content-center bg-dark text-uppercase border-inner p-4 mb-5">
                        <li class="nav-item">
                            <a class="nav-link text-white active" data-bs-toggle="pill" href="#tab-1">cake</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" data-bs-toggle="pill" href="#tab-2">drinks</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" data-bs-toggle="pill" href="#tab-3">snaks</a>
                        </li>
                    </ul>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <div class="testimonial-item bg-dark text-white border-inner p-4">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <asp:Image class="img-fluid flex-shrink-0" ID="img1" runat="server" ImageUrl='<%# "~/img/"+Eval("product_image") %>' Style="width: 60px; height: 60px;" />
                                                    <div class="ps-3">
                                                        <h4 class="text-primary text-uppercase mb-1"><%#Eval("name") %></h4>
                                                        <div class="">
                                                            <h6 class="text-primary text-uppercase mb-1"><i class="bi bi-currency-rupee text-dark"></i><%#Eval("cost") %></h6>
                                                            <asp:LinkButton ID="lbAddToCart" runat="server" CommandName="addtocart" CommandArgument='<%#Eval("id") %>'> <i class="fas fa-shopping-cart"></i></asp:LinkButton>
                                                        </div>
